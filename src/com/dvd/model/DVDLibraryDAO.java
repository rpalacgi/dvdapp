...
public class DVDLibraryDAO {
  ...
  private static final String GET_LIBRARY_ITEMS
    = "SELECT id, title, year, genre FROM Item WHERE username=?";
  private static final String CREATE_DVD_ITEM
    = "INSERT INTO Item (id, username, title, year, genre)"
    + " VALUES (?, ?, ?, ?, ?)";
  private static final String GET_GENRES
    = "SELECT DISTINCT genre FROM Item WHERE username=?";
